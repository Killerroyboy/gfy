...
**§21 PUSHED + LIVE 2026-07-31:** main = `f6e2ce7`, live md5 == tip, suppression strings served. Next-push rollback ref = `f6e2ce7`. RILEY RATIFIED: unsold-lot rule = STAYS IN POT, disclosed → §22 wave launching (unsold placing lot excluded from covered payout math + disclosure fires) bundled with suppression copy/coverage polish.

## 2026-07-31 — §22 wave COMPLETE + MERGED (local)
